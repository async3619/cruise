...
import { Cursor, Filled, PlayTime, Progress, ProgressWrapper, Root } from "@components/PlayerControl.styles";

import formatDuration from "@utils/formatDuration";

export interface PlayerControlProps extends WithPlayerProps {}
export interface PlayerControlStates {}

class PlayerControl extends React.Component<PlayerControlProps, PlayerControlStates> {
...
export default withPlayer(PlayerControl);
