...
const ControlButtonIcons: Record<WindowControlButtonTypes, React.ComponentType> = {
    minimize: () => (
        <Icon x="0px" y="0px" viewBox="0 0 10.2 1" data-testid="minimize-icon">
            <rect width="10.2" height="1" />
        </Icon>
    ),
    maximize: () => (
        <Icon x="0px" y="0px" viewBox="0 0 10.2 10.1" data-testid="maximize-icon">
            <path d="M0,0v10.1h10.2V0H0z M9.2,9.2H1.1V1h8.1V9.2z" />
        </Icon>
    ),
    close: () => (
        <Icon x="0px" y="0px" viewBox="0 0 10.2 10.2" data-testid="close-icon">
...
export function WindowControlButton({ type, ...rest }: WindowControlButtonProps) {
    ...
    return (
        <Root buttonType={type} {...rest} data-testid="window-control-button">
            <Icon />
        </Root>
    );
}
